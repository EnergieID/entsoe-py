...
lst = list()
for bzn in IT_BZ:
    s = e.query_unavailability_of_production_units(domain=bzn[0], docstatus=None, start=start, end=end)
    if s is not None:
        lst.append(s)
