...
class Area(enum.Enum):
    ...
    NO1_A =           '10Y1001A1001A64J', 'NO1A BZN',                                                   'Europe/Oslo',
    NORDIC =          '10Y1001A1001A91G', 'Nordic SNA / REG / LFB',                                     'MISSING!!!',
    AM =              '10Y1001A1001B004', 'Armenia BZN / CTA',                                          'MISSING!!!',
    GE =              '10Y1001A1001B012', 'CTA|GE, BZN|GE, Georgia (GE), SCA|GE, MBA|GE',               'MISSING!!!',
    AZ =              '10Y1001A1001B05V', 'Azerbaijan (AZ), BZN|AZ, CTA|AZ',                            'MISSING!!!',
    CZ_DE_SK_LT_SE4 = '10Y1001C--00038X', 'BZA|CZ-DE-SK-LT-SE4',                                        'MISSING!!!',
    CORE =            '10Y1001C--00059P', 'REG|CORE',                                                   'MISSING!!!',
    AFFR =            '10Y1001C--00090V', 'REG|AFRR, SCA|AFRR',                                         'MISSING!!!',
    SWE =             '10Y1001C--00095L', 'REG|SWE',                                                    'MISSING!!!',
    IN =              '10Y1001C--00119X', 'SCA|IN',                                                     'MISSING!!!',
    NO2_A =           '10Y1001C--001219', 'BZN|NO2A',                                                   'MISSING!!!',
    IT_NOR =          '10Y1001C--00137V', 'REG|ITALYNORTH',                                             'MISSING!!!',
    GRIT =            '10Y1001C--00138T', 'REG|GRIT',                                                   'MISSING!!!',
    DE_DK1_LU =       '10YCB-GERMANY--8', 'SCA|DE_DK1_LU, LFB|DE_DK1_LU',                               'MISSING!!!',
    RS_MK_ME =        '10YCB-JIEL-----9', 'LFB|RS_MK_ME',                                               'MISSING!!!',
    PL_Z =            '10YCB-POLAND---Z', '10YCB-POLAND---Z',                                           'MISSING!!!',
    SI_HR_BA =        '10YCB-SI-HR-BA-3', 'LFB|SI_HR_BA',                                               'MISSING!!!',
    DK1_A=            '10YDK-1-------AA', 'BZN|DK1A',                                                   'MISSING!!!',
    LT_SE4 =          '10YDOM-PL-SE-LT2', 'BZA|LT-SE4',                                                 'MISSING!!!',
    CON_EUR =         '10YEU-CONT-SYNC0', 'SNA|Continental Europe',                                     'MISSING!!!',
    DK1_NO1 =         '46Y000000000007M', 'BZN|DK1-NO1',                                                'MISSING!!!',
